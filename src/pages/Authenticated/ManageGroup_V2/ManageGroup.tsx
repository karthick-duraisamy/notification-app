...
import { setActionId, setUnwantedTrigger } from '@/stores/TemplateProject.store';
...
import { CustomViewIcon, CustomDeleteIcon, CustomEditIcon } from '@/components/Icons/Icons';
              ...
              <Col className="cls-table-card">
                <Row>
                  ...
                  >
                    <Button
                      type="primary"
                      className={SelectedView === 'Table' ? 'cls-selected' : ''}
                      onClick={() => cardTable('Table')}
                    >
                      {SelectedView === 'Table' ? <TablelightAnimation /> : <TabledarkAnimation />}
                    </Button>
                  </Tooltip>
                  <Tooltip
                    title="Card View"
                  ...
                  >
                    <Button
                      type="primary"
                      className={SelectedView === 'Card' ? 'cls-selected' : ''}
                      onClick={() => cardTable('Card')}
                    >
                      {SelectedView === 'Card' ? <CardlightAnimation /> : <CardDarkAnimation />}
                    </Button>
                  </Tooltip>
                </Row>
              </Col>
