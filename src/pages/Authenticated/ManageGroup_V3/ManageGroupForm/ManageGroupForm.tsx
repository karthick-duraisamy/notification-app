...
import { ReloadOutlined, DeleteOutlined, UserAddOutlined } from '@ant-design/icons';
...
import { ImportingIcon, UploadingIcon } from '@/components/Icons/Icons';
      ...
      <>
        <Row gutter={32}>
          <Col xs={24} sm={24} md={12} lg={12} xl={12} xxl={12}>
            <Form.Item
              name="group_name"
              label={<div style={{ fontSize: '16px' }}>Group name</div>}
              rules={[
                {
                  required: true,
          ...
          <Col xs={24} sm={24} md={12} lg={12} xl={12} xxl={12}>
            <Form.Item name="topic" label={<div style={{ marginBottom: '7px', fontSize: '16px' }}>Topic</div>}>
              <FolderFilter
                folders={[]}
          ...
          <Col xs={24} sm={24} md={24} lg={24} xl={24} xxl={24}>
            <Form.Item name="description" label={<div style={{ fontSize: '16px' }}>Description detail</div>}>
      ...
      <>
        <Row gutter={32}>
          <Col span={24} style={{ paddingBottom: '8px' }}>
            <label>
              <div className="cls-form-sub-title">Contact add by :</div>
            </label>
          </Col>
          <Col xs={24} sm={24} md={24} lg={24} xl={24} xxl={24}>
            <Form.Item
                ...
                <Row gutter={24}>
                  ...
                  <Col span={12}>
                    <Radio value="manual" className="radio-manual ">
                      <div className="radio-content">
                        <div className="radio-text">
                          <UserAddOutlined className="radio-icon" />
            ...
            <Row className="cls-form-btns" gutter={32} justify="end">
              ...
              <Col>
                <Button htmlType="submit" type="primary" size="middle">
                  {isLoading ? <LoadingOutlined /> : <span>Submit</span>}
                </Button>
              </Col>
            </Row>
          </Form>
